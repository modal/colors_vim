...
exe "hi Comment        start=[m[37m      stop=[m[32m   ctermfg=".s:white."                             guifg=white                           term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold.s:italic
...
exe "hi DiffAdd        start=[m[37;45m   stop=[m[32m   ctermfg=".s:white."     ctermbg=".s:magenta."   guifg=White       guibg=Magenta       term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
exe "hi DiffChange     start=[m[33;44m   stop=[m[32m   ctermfg=".s:yellow."    ctermbg=".s:blue."      guifg=Yellow      guibg=Blue          term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
exe "hi DiffDelete     start=[m[37;44m   stop=[m[32m   ctermfg=".s:white."     ctermbg=".s:blue."      guifg=White       guibg=Blue          term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
exe "hi DiffText       start=[m[37;41m   stop=[m[32m   ctermfg=".s:white."     ctermbg=".s:red."       guifg=White       guibg=Red           term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi ErrorMsg       start=[m[37;41m   stop=[m[32m   ctermfg=".s:white."     ctermbg=".s:red."       guifg=White       guibg=Red           term=standout".s:bold."         cterm=none".s:bold."              gui=none".s:bold
...
exe "hi LineNr         start=[m[33m      stop=[m[32m   ctermfg=".s:yellow." ".s:ulbg."                 guifg=Yellow                          term=none".s:underline.s:bold." cterm=none".s:bold."              gui=none".s:bold
...
exe "hi MatchParen     start=[m[34;46m   stop=[m[32m   ctermfg=".s:blue."      ctermbg=".s:cyan."      guifg=blue        guibg=cyan          term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
exe "hi Menu           start=[m[30;44m   stop=[m[32m                                                   guifg=black       guibg=gray75        term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi SignColumn     start=[m[37;40m   stop=[m[32m   ctermfg=".s:white."     ctermbg=".s:black."     guifg=white       guibg=black         term=none".s:bold."             cterm=none".s:bold."              gui=none".s:bold
...
exe "hi User1          start=[m[37;44m   stop=[m[32m   ctermfg=".s:white."     ctermbg=".s:blue."      guifg=white       guibg=blue"
exe "hi User2          start=[m[36;44m   stop=[m[32m   ctermfg=".s:cyan."      ctermbg=".s:blue."      guifg=cyan        guibg=blue"
exe "hi User3          start=[m[32;44m   stop=[m[32m   ctermfg=".s:green."     ctermbg=".s:blue."      guifg=green       guibg=blue"
exe "hi User4          start=[m[32;44m   stop=[m[32m   ctermfg=".s:red."       ctermbg=".s:blue."      guifg=red         guibg=blue"
" vim: nowrap
