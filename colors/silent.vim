...
hi Normal	        guibg=White		guifg=#141312	gui=italic
...
hi Constant	        guibg=#eeeeee 	guifg=#333333	gui=bold
...
hi Number	        guibg=white 	guifg=#B07E00	gui=bold
"hi Boolean	        guibg=#fecefe 	guifg=#333333	gui=bold
hi Boolean	        guibg=#eeeeee 	guifg=#333333	gui=bold
...
" int char
hi Type		        guibg=white		guifg=black		gui=bold
...
hi TODO				guibg=white		guifg=red		gui=underline
